...
# Create a room (v1 requires the owners user id)
client.create_room('my room', {owner_user_id => 998324})

# Options for creating a room
options = {:privacy => ('public' || 'private'), :topic => 'I'm a room topic', :guest_access => (0 || 1)}
client.create_room('my room, now with options', options)
...
# Create a room
client.create_room('my room')
# Options for creating a room
options = {:privacy => ('public' || 'private'), :guest_access => (0 || 1), :owner_user_id}
client.create_room('my room, now with options', options)

# Invite user to room
client['my room'].invite_user("this.user@hipchat.com", 'This is where the reason goes')
